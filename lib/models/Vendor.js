...
const VendorSchema = new mongoose.Schema({
  ...
  contact: { type: String },
  // Voice-call number when it differs from WhatsApp (`contact`).
  contactCall: { type: String },
  image: { type: String },
  ...
  // Set once an agent/admin chose event types. Legacy vendors without this
  // still appear for every event so the catalog does not go empty overnight.
  eventTypesExplicit: { type: Boolean, default: false },
  eventPrices: [{
    eventType: String,
    originalPrice: String,
    price: String,
